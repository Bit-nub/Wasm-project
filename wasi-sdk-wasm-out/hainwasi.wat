(module
  ...
  (type (;14;) (func (param i32 i32 i32 i32 i32) (result f64)))
  ...
  (func $getMatrixElements (type 8) (param i32 i32 i32)
    ...
    global.set $__stack_pointer
    return)
  (func $multiplyMatrices (type 9) (param i32 i32 i32 i32 i32 i32 i32)
  ...
  (func $__shgetc (type 2) (param i32) (result i32)
    ...
    local.get 2)
  (func $__intscan (type 12) (param i32 i32 i32 i64) (result i64)
    ...
    global.set $__stack_pointer
    local.get 3)
  (func $__floatscan (type 13) (param i32 i32 i32) (result f64)
    ...
    global.set $__stack_pointer
    local.get 7)
  (func $hexfloat (type 14) (param i32 i32 i32 i32 i32) (result f64)
  ...
  (func $dlmalloc (type 2) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        i32.const 0
        i64.const -1
        i64.store offset=6112 align=4
        i32.const 0
        i64.const 281474976776192
        i64.store offset=6104 align=4
        i32.const 0
        local.get 1
        i32.const 8
        i32.add
        ...
        i32.xor
        local.tee 4
        i32.store offset=6100
        i32.const 0
        i32.const 0
        i32.store offset=6120
        i32.const 0
        i32.const 0
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=6084 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=6076 align=4
  ...
  (func $printf_core (type 17) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 15)
  (func $pop_arg (type 8) (param i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
