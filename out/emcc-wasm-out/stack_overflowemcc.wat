(module
  ...
  (func (;36;) (type 5) (param i32 i32) (result i32)
    ...
    local.get 2
    select)
  (func (;37;) (type 13) (param f64 i32) (result f64)
    (local i64 i32)
    block  ;; label = @1
      local.get 0
      i64.reinterpret_f64
  ...
  (func (;39;) (type 1) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func (;40;) (type 14) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 208
    i32.sub
  ...
  (func (;49;) (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.const 10
    call 40)
  (func (;50;) (type 7) (param i32 f64 i32 i32 i32 i32) (result i32)
  ...
  (export "stackSave" (func 67))
  (export "stackRestore" (func 68))
  (export "stackAlloc" (func 69))
  (elem (;0;) (i32.const 1) func 9 10 8 7 6 21 20 22 50 51 55 57)
