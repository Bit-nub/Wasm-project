(module
  ...
  (func $_cleanup_r (type 3) (param i32)
    ...
    call $_fwalk_reent
    drop)
  (func $extended_gcd (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get 0
    local.tee 4
    i32.const -8
