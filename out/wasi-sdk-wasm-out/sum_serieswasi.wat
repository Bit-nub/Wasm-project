(module
  ...
  (func $__original_main (type 8) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f32 i32 i32 i32 i32 i32 i32 i32 i32 f32 i32 f32 i32 f32 f32 f32 i32 i32 i32 f32 f64 i32 i32 i32 i32)
    global.get 0
    local.set 0
    i32.const 48
    local.set 1
  ...
  (func $dlmalloc (type 2) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        i32.const 0
        i64.const -1
        i64.store offset=5888 align=4
        i32.const 0
        i64.const 281474976776192
        i64.store offset=5880 align=4
        i32.const 0
        local.get 1
        i32.const 8
        i32.add
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=5860 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=5852 align=4
